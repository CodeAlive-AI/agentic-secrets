...
public struct ShimExecPlanIPCResponse: Codable, Equatable, Sendable {
    ...
    public var manifests: [DeliveryDecisionManifest]
    ...
    public init(
        ...
        targetPath: String,
        argv: [String],
        manifests: [DeliveryDecisionManifest],
...
public struct ExecPlan: Equatable, Sendable {
    ...
    public var manifest: DeliveryDecisionManifest
}
...
public struct ShimExecutionPlanner: Sendable {
    ...
    public func plan(
        ...
        let intent = DeliveryRequest(flow: .cliEnv, secretAlias: targetPolicy.secretAlias, delivery: .env, environmentName: targetPolicy.environmentName, workspace: request.workspace, originHint: request.originHint)
