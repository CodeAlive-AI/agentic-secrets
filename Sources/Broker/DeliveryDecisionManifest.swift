...
public struct DeliveryDecisionManifest: Codable, Equatable, Sendable {
...
public enum ApprovalOption: String, Codable, Equatable, Sendable {
    ...
    public init(authorizationMode: DeliveryAuthorizationMode) {
...
public struct DeliveryDecisionManifestFactory: Sendable {
    public init() {}

    public func make(command: NormalizedCommand, intent: DeliveryRequest, target: TargetAssessment, deltas: [String] = []) -> DeliveryDecisionManifest {
        ...
        return DeliveryDecisionManifest(
