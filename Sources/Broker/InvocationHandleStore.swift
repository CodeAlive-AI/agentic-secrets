...
public struct InvocationBinding: Codable, Equatable, Sendable {
    ...
    public var injectionMode: DeliveryMechanism

    public init(peerIdentity: String, injectorIdentity: String, targetIdentity: String, actionClass: String, workspace: String, originHint: String, policyEpoch: Int, injectionMode: DeliveryMechanism) {
